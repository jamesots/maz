...
describe('parser', function() {
    ...
    const opcodes = [
        ...
        ['ld bc,chr', [0x01, {expression:'chr'}, null]],
        ['ld (bc),a', [0x02]],
        ['inc bc', [0x03]],
        ['inc b', [0x04]],
        ['dec b', [0x05]],
        ['ld b,$12', [0x06, 0x12]],
        ['ld b,chr', [0x06, {expression:'chr'}]],
        ['rlca', [0x07]],
        ['ex af,af\'', [0x08]],
        ['add hl,bc', [0x09]],
        ['ld a,(bc)', [0x0a]],
        ...
        ['dec c', [0x0d]],
        ['ld c,$12', [0x0e, 0x12]],
        ['ld c,chr', [0x0e, {expression:'chr'}]],
        ['rrca', [0x0f]],
        ['djnz $100', [0x10, {
            relative: 256
        }]],
        ['djnz chr', [0x10, {
            relative: {expression: 'chr'}
        }]],
        ['ld de,$543F', [0x11, 0x3f, 0x54]],
        ['ld de,chr', [0x11, {expression:'chr'}, null]],
        ['ld (de),a', [0x12]],
        ['inc de', [0x13]],
        ['inc d', [0x14]],
        ['dec d', [0x15]],
        ['ld d,$fe', [0x16, 0xfe]],
        ['ld d,chr', [0x16, {expression:'chr'}]],
        ['rla', [0x17]],
        ['jr $100', [0x18, {
            relative: 256
        }]],
        ...
        ['ld hl,chr', [0x21, {expression:'chr'}, null]],
        ['ld ($1234),hl', [0x22, 0x34, 0x12]],
        ['ld (chr),hl', [0x22, {expression:'chr'}, null]],
        ['inc hl', [0x23]],
        ['inc h', [0x24]],
        ['dec h', [0x25]],
        ['ld h,$9a', [0x26, 0x9a]],
        ['ld h,chr', [0x26, {expression:'chr'}]],
        ['daa', [0x27]],
        ['jr z,$100', [0x28, {
            relative: 256
        }]],
        ...
        ['ld hl,(chr)', [0x2a, {expression:'chr'}, null]],
        ['dec hl', [0x2b]],
        ['inc l', [0x2c]],
        ['dec l', [0x2d]],
        ['ld l,$42', [0x2e, 0x42]],
        ['ld l,chr', [0x2e, {expression:'chr'}]],
        ['cpl', [0x2f]],
        ['jr nc,$100', [0x30, {
            relative: 256
        }]],
        ...
        ['ld sp,chr', [0x31, {expression:'chr'}, null]],
        ['ld ($1234),a', [0x32, 0x34, 0x12]],
        ['ld (chr),a', [0x32, {expression:'chr'}, null]],
        ['inc sp', [0x33]],
        ['inc (hl)', [0x34]],
        ['dec (hl)', [0x35]],
        ['ld (hl),$9a', [0x36, 0x9a]],
        ['ld (hl),chr', [0x36, {expression:'chr'}]],
        ['scf', [0x37]],
        ['jr c,$100', [0x38, {
            relative: 256
        }]],
        ...
        ['ld a,(chr)', [0x3a, {expression:'chr'}, null]],
        ['dec sp', [0x3b]],
        ['inc a', [0x3c]],
        ['dec a', [0x3d]],
        ['ld a,$42', [0x3e, 0x42]],
        ['ld a,chr', [0x3e, {expression:'chr'}]],
        ['ccf', [0x3f]],
        ...
        ['jp nz,chr', [0xc2, {expression:'chr'}, null]],
        ['jp $1234', [0xc3, 0x34, 0x12]],
        ['jp chr', [0xc3, {expression:'chr'}, null]],
        ['call nz,$1234', [0xc4, 0x34, 0x12]],
        ['call nz,chr', [0xc4, {expression:'chr'}, null]],
        ['push bc', [0xc5]],
        ['add a,$12', [0xc6, 0x12]],
        ['add a,chr', [0xc6, {expression:'chr'}]],
        ['rst 00h', [0xc7]],
        ['rst $00', [0xc7]],
        ...
        ['jp z,chr', [0xca, {expression:'chr'}, null]],
        ['call z,$1234', [0xcc, 0x34, 0x12]],
        ['call z,chr', [0xcc, {expression:'chr'}, null]],
        ['call $1234', [0xcd, 0x34, 0x12]],
        ['call chr', [0xcd, {expression:'chr'}, null]],
        ['adc a,$12', [0xce, 0x12]],
        ['adc a,chr', [0xce, {expression:'chr'}]],
        ['rst 08h', [0xcf]],
        ['rst $08', [0xcf]],
        ...
        ['jp nc,chr', [0xd2, {expression:'chr'}, null]],
        ['out ($12),a', [0xd3, 0x12]],
        ['out (chr),a', [0xd3, {expression:'chr'}]],
        ['call nc,$1234', [0xd4, 0x34, 0x12]],
        ['call nc,chr', [0xd4, {expression:'chr'}, null]],
        ['push de', [0xd5]],
        ['sub a,$12', [0xd6, 0x12]],
        ['sub a,chr', [0xd6, {expression:'chr'}]],
        ['sub $12', [0xd6, 0x12]],
        ['sub chr', [0xd6, {expression:'chr'}]],
        ['rst 10h', [0xd7]],
        ['rst $10', [0xd7]],
        ...
        ['jp c,chr', [0xda, {expression:'chr'}, null]],
        ['in a,($12)', [0xdb, 0x12]],
        ['in a,(chr)', [0xdb, {expression:'chr'}]],
        ['call c,chr', [0xdc, {expression:'chr'}, null]],
        ['pfix', [0xdd]],
        ['sbc a,$12', [0xde, 0x12]],
        ['sbc a,chr', [0xde, {expression:'chr'}]],
        ['rst 18h', [0xdf]],
        ['rst $18', [0xdf]],
        ...
        ['jp po,chr', [0xe2, {expression:'chr'}, null]],
        ['ex (sp),hl', [0xe3]],
        ['call po,$1234', [0xe4, 0x34, 0x12]],
        ['call po,chr', [0xe4, {expression:'chr'}, null]],
        ['push hl', [0xe5]],
        ['and a,$12', [0xe6, 0x12]],
        ['and a,chr', [0xe6, {expression:'chr'}]],
        ['and $12', [0xe6, 0x12]],
        ['and chr', [0xe6, {expression:'chr'}]],
        ['rst 20h', [0xe7]],
        ['rst $20', [0xe7]],
        ...
        ['jp pe,chr', [0xea, {expression:'chr'}, null]],
        ['ex de,hl', [0xeb]],
        ['call pe,$1234', [0xec, 0x34, 0x12]],
        ['call pe,chr', [0xec, {expression:'chr'}, null]],
        ['xor a,$12', [0xee, 0x12]],
        ['xor a,chr', [0xee, {expression:'chr'}]],
        ['xor $12', [0xee, 0x12]],
        ['xor chr', [0xee, {expression:'chr'}]],
        ['rst 28h', [0xef]],
        ['rst $28', [0xef]],
        ...
        ['jp p,chr', [0xf2, {expression:'chr'}, null]],
        ['di', [0xf3]],
        ['call p,$1234', [0xf4, 0x34, 0x12]],
        ['call p,chr', [0xf4, {expression:'chr'}, null]],
        ['push af', [0xf5]],
        ['or a,$12', [0xf6, 0x12]],
        ['or a,chr', [0xf6, {expression:'chr'}]],
        ['or $12', [0xf6, 0x12]],
        ['or chr', [0xf6, {expression:'chr'}]],
        ['rst 30h', [0xf7]],
        ['rst $30', [0xf7]],
        ...
        ['jp m,chr', [0xfa, {expression:'chr'}, null]],
        ['ei', [0xfb]],
        ['call m,$1234', [0xfc, 0x34, 0x12]],
        ['call m,chr', [0xfc, {expression:'chr'}, null]],
        ['pfiy', [0xfd]],
        ['cp a,$12', [0xfe, 0x12]],
        ['cp a,chr', [0xfe, {expression:'chr'}]],
        ['cp $12', [0xfe, 0x12]],
        ['cp chr', [0xfe, {expression:'chr'}]],
        ['rst 38h', [0xff]],
        ['rst $38', [0xff]],
        ...
        ['ld (chr),bc', [0xed, 0x43, {expression:'chr'}, null]],
        ['neg', [0xed, 0x44]],
        ['retn', [0xed, 0x45]],
        ['im 0', [0xed, 0x46]],
        ['ld i,a', [0xed, 0x47]],
        ...
        ['ld bc,(chr)', [0xed, 0x4b, {expression:'chr'}, null]],
        ['reti', [0xed, 0x4d]],
        ['ld r,a', [0xed, 0x4f]],
